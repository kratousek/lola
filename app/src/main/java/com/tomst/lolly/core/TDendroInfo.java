...
public class TDendroInfo {
    ...
    public Long startLine, endLine, longitude, latitude;     //include picture later
    public ArrayList<TMereni> mers = new ArrayList<TMereni>();    //an array of measurements (lines of a file)
